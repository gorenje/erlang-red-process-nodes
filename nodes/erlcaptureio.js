module.exports = function(RED) {
  function CoreerlcaptureioFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("erlcaptureio.label.statusset") });
  ...
  RED.nodes.registerType("erlcaptureio", CoreerlcaptureioFunctionality);
