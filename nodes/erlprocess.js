module.exports = function(RED) {
  function CoreerlprocessFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("erlprocess.label.statusset") });
  ...
  RED.nodes.registerType("erlprocess", CoreerlprocessFunctionality);
